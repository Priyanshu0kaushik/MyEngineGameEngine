...
public:
    void Init() {
        ...
        AddShader("GBufferShader", "Shaders/GBufferVertexShader.glsl", "Shaders/GBufferFragmentShader.glsl");
        AddShader("DeferredLighting", "Shaders/LightingPassVertexShader.glsl", "Shaders/LightingPassFragmentShader.glsl");
    }
